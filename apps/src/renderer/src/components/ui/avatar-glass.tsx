...
interface AvatarGlassRootProps extends React.ComponentPropsWithoutRef<
...
>(
  (
    { className, size = 'md', status, glowing = false, children, ...props },
    ref,
  ) => {
...
type AvatarGlassImageProps = React.ComponentPropsWithoutRef<
...
type AvatarGlassFallbackProps = React.ComponentPropsWithoutRef<
