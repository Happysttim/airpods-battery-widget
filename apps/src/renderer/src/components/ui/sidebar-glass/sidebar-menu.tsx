...
import { TooltipGlassSimple } from '@/components/ui/tooltip-glass';
  ...
  ({ children, className, ...props }, ref) => {
    return (
      <li
        ...
        className={cn(
          'group/menu-item relative text-[var(--sidebar-foreground)]/60',
          className,
        )}
        {...props}
      >
...
const SidebarMenuSubContext = createContext<SidebarMenuSubContextValue | null>(
  null,
);
