...
import { FormFieldWrapper } from '@/components/glass/primitives/form-field-wrapper';
import {
  inputVariants,
  type InputGlassSize,
} from '@/lib/variants/input-glass-variants';
import {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <ChevronsUpDownIcon
            className={cn(ICON_SIZES.md, 'shrink-0 opacity-50')}
          />
        </ButtonGlass>
      </PopoverTrigger>
      <PopoverContent
      ...
      >
        ...
        >
          ...
          <CommandList className="p-1.5 scrollbar-hide">
            <CommandEmpty className="text-[var(--text-muted)] py-4">
              {emptyText}
            </CommandEmpty>
                  ...
                  >
                    <CheckIcon
                      className={cn(
                        ...
                        'shrink-0',
                        isSelected
                          ? 'opacity-100 text-[var(--text-accent)]'
                          : 'opacity-0',
                      )}
                    />
                    {OptionIcon && (
                      <OptionIcon
                        className={cn(
                          ICON_SIZES.md,
                          'shrink-0 text-[var(--dropdown-icon)]',
                        )}
                      />
                    )}
